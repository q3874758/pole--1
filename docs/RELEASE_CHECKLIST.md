...
- 依据：`docs/待解决问题清单.md`（27 项）、`IMPLEMENTATION_PLAN.md`、六子代理全面分析、跨语言契约核对、发行曲线量化模拟。
...
- [ ] **6.1 删除 legacy/**（29 文件，398b1c3 已归档，零引用）
- [ ] **6.2 删除 docs/aardio重写方案评估.md**（决策已被否决）
- [ ] **6.3 删除 docs/六大P0阻断问题解决方案.md + docs/待解决问题清单.md**（5 月旧方案，已被本清单取代）
- [ ] **6.4 删除 src/proto.rs**（991 行死代码，零引用零测试，lib.rs:181 同步删导出）
- [ ] **6.5 troubleshooting.md 错误仓库链接**：`pole-local/pole` → `q3874758/pole--1`
